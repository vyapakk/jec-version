/**
 * Layout components for Boeing Deliveries: Header, Skeleton, ScrollToTop, YearSelector.
 * Reuses patterns from boeing-gross-orders/layout.tsx.
 */
...
export function DashboardHeader({ title = "Boeing Deliveries", subtitle = "Historical Aircraft Deliveries Dashboard" }: { title?: string; subtitle?: string }) {
  return (
...
export function YearSelector({ value, onChange, years = [] }: { value: number; onChange: (year: number) => void; years?: number[] }) {
  return (
