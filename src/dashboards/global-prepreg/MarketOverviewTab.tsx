/**
 * Market Overview Tab — Global Prepreg with unit-aware formatting.
 */
...
export function MarketOverviewTab({ marketData, selectedYear, onNavigateToTab }: MarketOverviewTabProps) {
  ...
  const handleSliceClick = (segmentName: string, segmentData: YearlyData[], color: string, donutType: TabType) => {
    ...
    switch (donutType) {
      ...
      case "equipment": relatedSegments = { title: "By Region", data: marketData.region }; break;
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <DistributionDonutsRow
          ...
          equipmentData={marketData.furnishedEquipment?.length ? marketData.furnishedEquipment : []}
          processTypeData={marketData.processType}
          year={selectedYear}
          onDonutClick={onNavigateToTab}
          onSliceClick={handleSliceClick}
          endUserLabel={labels.endUser}
          aircraftLabel={config.segmentMapping.aircraft?.title ?? "Resin Type"}
