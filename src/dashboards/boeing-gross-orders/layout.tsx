/**
 * Layout components: Header, Skeleton, ScrollToTop, YearSelector.
 */
...
export function DashboardHeader({ title = "Boeing Gross Orders", subtitle = "Historical Aircraft Orders Dashboard" }: { title?: string; subtitle?: string }) {
  return (
