/**
 * UI helper components: AnimatedCounter, KPICard, ChartDownloadButton,
...
export function KPICard({ title, value, prefix = "", suffix = "", decimals = 0, icon: Icon, delay = 0, accentColor = "primary" }: {
