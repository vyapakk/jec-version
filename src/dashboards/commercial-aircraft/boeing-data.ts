/**
 * Boeing data parsing, types, and hooks — internalized for commercial-aircraft dashboard.
 * Standalone copy of boeing-combined/data.ts with no cross-folder imports.
 */
