/**
 * Boeing Gross Orders tab — internalized for commercial-aircraft dashboard.
 */
...
import { useOrderData, useDrillDown, type OrderCustomerSummary } from "./boeing-data";
...
export function BoeingGrossOrdersTab() {
  ...
  return (
    <div className="py-8">
      ...
      <div className="mb-8"><MultiLineChart data={data.ordersByYearByModelFamily} years={filteredYears} title="Gross Orders by Aircraft Model" subtitle="Order trends by model family" segments={data.modelFamilies} onSegmentClick={handleDrillDown} downloadTitle="Boeing Gross Orders — By Aircraft Model" gradientPrefix="bgo-mf" /></div>
      <div className="mb-8"><MultiLineChart data={data.ordersByYearByRegion} years={filteredYears} title="Gross Orders by Region" subtitle="Order trends by geographic region" segments={data.regions} onSegmentClick={handleDrillDown} downloadTitle="Boeing Gross Orders — By Region" gradientPrefix="bgo-rg" /></div>
