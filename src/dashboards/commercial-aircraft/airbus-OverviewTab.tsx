/**
 * Overview tab for Airbus — internalized for commercial-aircraft dashboard.
 */
...
import { useAirbusSummaryOverview, type AirbusSummaryOverviewData } from "./airbus-data";
import { KPICard } from "./ui-helpers";
import { GroupedBarChart, SimpleDonutChart } from "./airbus-charts";
...
export function AirbusOverviewTab({ onTabChange }: OverviewTabProps) {
