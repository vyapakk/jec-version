/**
 * Layout components for Glass Fiber Prepreg dashboard.
 * Includes unit toggle for Dual style.
 */
    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2"><div className="rounded-xl border border-border bg-card p-6"><Skeleton className="mb-4 h-6 w-48" /><Skeleton className="h-[350px] w-full" /></div></div>
