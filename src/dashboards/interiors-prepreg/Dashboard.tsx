/**
 * Main Dashboard Page — Aircraft Interiors Prepreg.
...
import { useMarketData, UnitContext, VALUE_UNIT } from "./data";
...
const InteriorsPrepregDashboard = () => {
  ...
  const getSegmentInfo = () => {
    ...
    if (!mapping) return { data: marketData.endUser, title: "Application Type" };
  ...
  return (
    <UnitContext.Provider value={VALUE_UNIT}>
...
export default InteriorsPrepregDashboard;
