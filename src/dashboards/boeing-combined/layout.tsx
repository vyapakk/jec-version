/**
 * Layout components for Boeing Combined dashboard.
...
export function DashboardHeader({ title = "Boeing Commercial Aircraft Orders & Deliveries", subtitle = "Comprehensive Orders, Deliveries & Backlog Dashboard" }: { title?: string; subtitle?: string }) {
  return (
