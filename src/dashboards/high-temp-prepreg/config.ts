...
export const config = {
  dataUrl: "/data/high-temperature-prepreg-market.json",
  title: "High Temperature Prepregs Market",
  subtitle: "Global Market Research Dashboard",
  defaultYear: 2025, useMillions: true,
  footerText: "High Temperature Prepregs Market Research Report",
  ...
  tabs: [
    ...
    { id: "equipment", label: "Curing Process", icon: Cog },
    { id: "region", label: "Region", icon: Globe },
  ] as TabConfig[],
  labels: {
    endUser: "End-Use Industry",
    equipment: "Curing Process",
  ...
  segmentMapping: {
    ...
    equipment:   { dataKey: "furnishedEquipment", title: "Curing Process" },
  } as Record<string, { dataKey: string; title: string }>,
  routePath: "/dashboard/high-temp-prepreg",
  catalog: { categoryId: "composites", datasetId: "prepregs", dashboardId: "pp-ht", datasetName: "Prepregs" },
} as const;
